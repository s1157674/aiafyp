...
$(document).ready(function(){ 
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            var html ="";
            html = html + "<div data-role='header' data-position='fixed' data-theme='b'><h1>"+tableName+"</h1>" ;
            html = html + "<a href='#' onclick='GoHome()' data-icon='back' data-iconpos='notext'>Refresh</a>";
            html = html + "</div>"
